...
import { PatientListForDoctorService } from './patient-list-for-doctor-service';
import { ViewPatientModal } from '../patient-list/view-patient-modal/view-patient-modal';

@Component({
  selector: 'app-patient-list-for-doctor',
  templateUrl: './patient-list-for-doctor.html',
  styleUrl: './patient-list-for-doctor.scss',
})
export class PatientListForDoctor implements OnInit {
  patients = signal<any[]>([]);
  loading = false;
  errorMessage = '';
  searchText = '';
  ...
  constructor(
    ...
    private patientListForDoctorService: PatientListForDoctorService,
